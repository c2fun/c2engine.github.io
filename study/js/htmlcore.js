  ...
  function loop(links, ul) {
    ...
    $.each(links, function(key,   obj) {
      ...
      if(obj['link'] == 'null'){
        ...
        var $a = $('<a>').attr('onclick',"RefreshIframe(\""+obj['link'] + '.html\")').text(obj['title']);
...
$(document).ready(function(){
	...
	var iframeheight = bodyheight - 360 ;
	$("#mainpage").attr("style","width:"+iframeheight + "px;"+"float:right");
	$("#mainpage").height("100%");
